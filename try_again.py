...
#backup file if you inserted your input wrong in currency.py
...
if fro not in currency_list or to not in currency_list:
  print  "Ohh there seems to be an error in your input, please start again" #if statement which shows if you entered your value in wrong